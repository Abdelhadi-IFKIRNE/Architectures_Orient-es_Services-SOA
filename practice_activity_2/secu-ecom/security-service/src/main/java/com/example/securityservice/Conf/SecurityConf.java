...
public class SecurityConf {
    ...
    @Bean
    JwtDecoder decoder(){
        return NimbusJwtDecoder.withPublicKey((RSAPublicKey) getPubAndPrivKeys.publicKey()).build();
    }
    @Bean
    public JwtEncoder encoder(){
        JWK jwk=new RSAKey.Builder((RSAPublicKey) getPubAndPrivKeys.publicKey()).privateKey(getPubAndPrivKeys.privateKey()).build();
